...
# user=postgres.zuqsszwvcnuyrehkdmlm password=3742Kamau@21 host=aws-0-us-west-1.pooler.supabase.com port=5432 dbname=postgres

DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.postgresql',
        'NAME': 'postgres',
        'USER': 'postgres.zuqsszwvcnuyrehkdmlm',
        'PASSWORD':"3742Kamau@21",
